package com.distributedwhiteboard.gui;
...
import com.distributedwhiteboard.impl.WhiteboardShape;
...
public class WhiteboardJPanel extends JPanel {
     ...
     */
    private Shape drawStar(double innerRadius, double centerX, double centerY) {
